...
class QuizQuestionActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun setQuestion() {
        ...
        // azert vannak a !! mert nullnak deklaraltuk
        //es ezt tenni kell mert biztosra tudjuk hogy
        // ebben a pontban nem lesz null
    ...
    private fun defaultOptionsView(){
        ...
        //mivel az option null van deklaralva
        //kell hasznalni a .let fuggvenyt
        tvOptionOne?.let{
            options.add(0, it)
        }
        tvOptionTwo?.let{
                ...
                if(mSelectedOptionPosition == 0){
                    ...
                    if(question!!.correctAnswer != mSelectedOptionPosition){
                         ...
                         answerView(question.correctAnswer,
                            R.drawable.corect_option_border_bg
                             )
                    }
                    else{
                        mCorrectAnswers ++
